...
const AttendanceCorrectionForm = ({
  ...
  return /*#__PURE__*/React.createElement("form", {
    ...
    htmlFor: "expectedCheckIn",
    className: "block text-sm font-medium text-gray-700 dark:text-gray-300"
  }, "Expected Check-in Time"), /*#__PURE__*/React.createElement("input", {
    type: "time",
    id: "expectedCheckIn",
    className: "mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm",
    ...
    className: "block text-sm font-medium text-gray-700 dark:text-gray-300"
  }, "Expected Check-out Time (Optional)"), /*#__PURE__*/React.createElement("input", {
    type: "time",
    id: "expectedCheckOut",
    className: "mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm",
    ...
    htmlFor: "reason",
    className: "block text-sm font-medium text-gray-700 dark:text-gray-300"
  }, "Reason for Correction"), /*#__PURE__*/React.createElement("textarea", {
    id: "reason",
    rows: "3",
    className: "mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm",
    value: reason,
