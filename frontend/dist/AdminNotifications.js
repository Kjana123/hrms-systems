...
const AdminNotifications = ({
  ...
  if (loadingEmployees) {
    return /*#__PURE__*/React.createElement("div", {
      className: `flex items-center justify-center p-8 ${darkMode ? 'text-white' : 'text-gray-800'}`
    }, /*#__PURE__*/React.createElement("div", {
      className: "flex space-x-2"
    }, /*#__PURE__*/React.createElement("div", {
      className: "w-4 h-4 rounded-full animate-pulse bg-blue-600"
    }), /*#__PURE__*/React.createElement("div", {
      className: "w-4 h-4 rounded-full animate-pulse bg-blue-600 animation-delay-200"
    }), /*#__PURE__*/React.createElement("div", {
      className: "w-4 h-4 rounded-full animate-pulse bg-blue-600 animation-delay-400"
    })), /*#__PURE__*/React.createElement("p", {
      className: "ml-4"
    }, "Loading employee data for notifications..."));
  }
  return /*#__PURE__*/React.createElement("div", {
    className: `p-6 rounded-xl shadow-lg ${darkMode ? 'bg-gray-700 text-white' : 'bg-white text-gray-900'}`
  }, /*#__PURE__*/React.createElement("h2", {
    className: "text-2xl font-bold mb-6 text-blue-600 dark:text-blue-300"
    ...
    value: ""
  }, "-- Select an Employee --"), " ", allEmployees.map(emp => /*#__PURE__*/React.createElement("option", {
    key: emp.id,
    value: emp.id
  }, emp.name, " (", emp.employee_id || emp.id, ")")))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    ...
    className: `w-full py-3 px-6 rounded-xl font-semibold transition-all duration-300 shadow-md transform hover:scale-105
                        ${sendingNotification || !notificationMessage.trim() || notificationType === 'specific' && !selectedEmployeeId ? 'bg-gray-400 text-gray-700 cursor-not-allowed' : 'bg-gradient-to-r from-blue-600 to-blue-800 text-white hover:from-blue-700 hover:to-blue-900'}`
