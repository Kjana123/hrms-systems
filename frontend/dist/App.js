...
const App = () => {
  ...
  if (loadingApp) {
    return /*#__PURE__*/React.createElement("div", {
      className: `flex items-center justify-center min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`
      ...
      className: "w-4 h-4 rounded-full animate-pulse bg-blue-600"
    }), /*#__PURE__*/React.createElement("p", null, "Loading application...")));
  }
  return /*#__PURE__*/React.createElement("div", {
    className: `min-h-screen flex flex-col ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'} font-sans`
  }, message.text && /*#__PURE__*/React.createElement(Message, {
